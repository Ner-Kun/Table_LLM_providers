document.addEventListener("DOMContentLoaded", function () {
  setTimeout(function () {
    document.querySelectorAll("code:not(.highlight code)").forEach(function (code) {
      if (code.parentNode.hasAttribute("data-inline-code-wrapper")) {
        return;
      }
    ...
    document.querySelectorAll('img.twemoji').forEach(function(emoji) {
