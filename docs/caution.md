...
<figure class="screenshot-gallery">
  <div class="screenshot-item">
    <img src="../images/caution/navyai-official-response.png" alt="NavyAI official response">
...
<figure class="screenshot-gallery">
  <div class="screenshot-item">
    <img src="../images/caution/navyai-sponsor-thanks.png" alt="Screenshot 1: Collaboration announcement with sponsor thanks">
...
<figure class="screenshot-gallery">
  <div class="screenshot-item">
    <img src="../images/caution/navyai-keys-leak.png" alt="Screenshot 2: Mr. Duke's message with leaked API keys">
...
<figure class="screenshot-gallery">
  <div class="screenshot-item">
    <img src="../images/caution/navyai-apology-screenshot.png" alt="Screenshot 3: My public apology from prior conflict">
    <figcaption>Screenshot 3: My public apology from a prior conflict with NavyAI</figcaption>
  </div>
  <div class="screenshot-item">
    <img src="../images/caution/navyai-deleted-messages.png" alt="Screenshot 4: Deleted messages - only my replies remain">
